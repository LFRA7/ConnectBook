...
export const Financial = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                // Filtrar Colaboradores apenas do departamento Financial
    ...
    return (
        <div className="container">
            <h2 className="mt-4">Colaboradores do Departamento de Finanças</h2>
            {users.length === 0 ? (
                <p>Nenhum Colaborador encontrado no departamento de Finanças.</p>
            ) : (
