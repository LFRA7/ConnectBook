...
export const EmployeeRelations = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Human Resources" && user.team === "Employee Relations");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Employee Relations - {visibleMembers.length}/{teamMembers.length}</h1>
