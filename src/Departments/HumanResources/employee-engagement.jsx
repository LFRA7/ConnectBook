...
export const EmployeeEngagement = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Employee Engagement Team is responsible for fostering a positive and motivated workplace culture, enhancing employee satisfaction, and driving organizational commitment. This team develops initiatives that improve employee morale, strengthen company values, and boost overall productivity.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Human Resources" && user.team === "Employee Engagement");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Employee Engagement - {visibleMembers.length}/{teamMembers.length}</h1>
