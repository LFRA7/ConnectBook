...
export const Training = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Training Team is responsible for developing and delivering learning programs that enhance employee skills, knowledge, and professional growth. This team ensures that employees receive the necessary training to excel in their roles and contribute to the company's success.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Human Resources" && user.team === "Training");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Training - {visibleMembers.length}/{teamMembers.length}</h1>
