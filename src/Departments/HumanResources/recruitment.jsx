...
export const Recruitment = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Recruitment Team is responsible for attracting, selecting, and hiring top talent to meet the company’s workforce needs. This team ensures that the organization acquires skilled professionals who align with its culture, values, and strategic goals.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Human Resources" && user.team === "Recruitment");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Recruitment - {visibleMembers.length}/{teamMembers.length}</h1>
