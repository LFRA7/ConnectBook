...
export const Networking = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Networking Team is responsible for designing, implementing, maintaining, and securing the organization's network infrastructure.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const NetworkingTeam = data.filter(user => user.department === "IT Services" && user.team === "Networking");
                setTeamMembers(NetworkingTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Networking - {visibleMembers.length}/{teamMembers.length}</h1>
