...
export const Support = () => {
    ...
    useEffect(() => {
        const teamDescription = "The IT Services Support Team is responsible for providing technical assistance and resolving IT-related issues across the organization. Our team ensures the smooth operation of IT systems, networks, and software applications by offering first-line and second-line support to employees and stakeholders.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SupportTeam = data.filter(user => user.department === "IT Services" && user.team === "Support");
                setTeamMembers(SupportTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Support - {visibleMembers.length}/{teamMembers.length}</h1>
