...
export const CloudServices = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Cloud Services Team is responsible for managing and optimizing cloud-based infrastructure, applications, and services. Their goal is to ensure secure, scalable, and efficient cloud solutions that support the organization’s digital transformation and operational needs.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const CloudServicesTeam = data.filter(user => user.department === "IT Services" && user.team === "Cloud Services");
                setTeamMembers(CloudServicesTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Cloud Services - {visibleMembers.length}/{teamMembers.length}</h1>
