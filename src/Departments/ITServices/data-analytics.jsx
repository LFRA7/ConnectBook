...
export const DataAnalytics = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const DataAnalyticsTeam = data.filter(user => user.department === "IT Services" && user.team === "Data Analytics");
                setTeamMembers(DataAnalyticsTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Data Analytics - {visibleMembers.length}/{teamMembers.length}</h1>
