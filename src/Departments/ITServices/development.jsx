...
export const Development = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Development Team is responsible for designing, developing, maintaining, and optimizing software applications and systems that support the organization's operations. Their primary focus is on creating efficient, scalable, and secure digital solutions that meet business requirements.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const DevelopmentTeam = data.filter(user => user.department === "IT Services" && user.team === "Development");
                setTeamMembers(DevelopmentTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Development - {visibleMembers.length}/{teamMembers.length}</h1>
