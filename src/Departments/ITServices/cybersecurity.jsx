...
export const Cybersecurity = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const CybersecurityTeam = data.filter(user => user.department === "IT Services" && user.team === "Cybersecurity");
                setTeamMembers(CybersecurityTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Cybersecurity - {visibleMembers.length}/{teamMembers.length}</h1>
