...
export const Procurement = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Procurement Team is responsible for sourcing, purchasing, and managing the supply of goods and services necessary for the company's operations. Their goal is to ensure cost-effective procurement while maintaining quality, supplier relationships, and compliance with company policies.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Administration" && user.team === "Procurement");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Procurement - {visibleMembers.length}/{teamMembers.length}</h1>
