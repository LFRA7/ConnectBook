...
export const FacilitiesManagement = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Facilities Management Team is responsible for overseeing the maintenance, safety, and efficiency of the company’s physical workspaces. Their goal is to ensure a well-functioning, safe, and sustainable environment for employees, visitors, and business operations.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Administration" && user.team === "Facilities Management");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Facilities Management - {visibleMembers.length}/{teamMembers.length}</h1>
