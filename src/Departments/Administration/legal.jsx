...
export const Legal = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Legal Team is responsible for ensuring the company operates within legal and regulatory frameworks, managing legal risks, and protecting the organization’s interests. Their goal is to provide legal guidance, ensure compliance, and handle contractual, corporate, and litigation matters.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Administration" && user.team === "Legal");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Legal - {visibleMembers.length}/{teamMembers.length}</h1>
