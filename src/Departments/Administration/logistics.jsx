...
export const Logistics = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Logistics Team is responsible for coordinating the efficient movement of goods, materials, and resources across the supply chain. Their goal is to ensure timely deliveries, optimize transportation and inventory management, and support overall business operations through effective logistics planning.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Administration" && user.team === "Logistics");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Logistics - {visibleMembers.length}/{teamMembers.length}</h1>
