...
export const HumanResources = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                // Filtrar apenas usuários do departamento Human Resources
                const hrUsers = data.filter(user => user.department === "Human Resources");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-human-resources">
                <div className="title-row">
                    <h1>Human Resources Department - {ownedUsers}/{totalUsers}</h1>
                    ...
                    {allTeams.map((teamName) => {
                        ...
                        return (
                            <div className="col" key={teamName}>
                                <div
                                    className="card-human-resources"
                                ...
                                >
                                    ...
                                    <div className="sticker-container-human-resources">
