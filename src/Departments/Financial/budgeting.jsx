...
export const Budgeting = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Budgeting Team is responsible for planning, managing, and monitoring the organization’s financial resources to ensure efficient allocation and cost control. Their main goal is to develop accurate financial plans that align with the organization's strategic objectives while optimizing expenditures.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Financial" && user.team === "Budgeting");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Budgeting - {visibleMembers.length}/{teamMembers.length}</h1>
