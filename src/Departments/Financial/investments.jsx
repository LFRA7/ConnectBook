...
export const Investments = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Investments Team is responsible for managing the company's investment portfolio, analyzing financial markets, and developing strategies to maximize returns while minimizing risks. This team conducts in-depth research on investment opportunities, including equities, bonds, real estate, and alternative assets, ensuring alignment with the organization’s financial goals.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Financial" && user.team === "Investments");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Investments - {visibleMembers.length}/{teamMembers.length}</h1>
