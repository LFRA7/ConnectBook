...
export const FinancialPlanning = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Financial" && user.team === "Financial Planning");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Financial Planning - {visibleMembers.length}/{teamMembers.length}</h1>
