...
export const Accounting = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Accounting Team is responsible for managing the organization's financial records, ensuring compliance with accounting standards, and providing accurate financial reporting. Their main goal is to maintain financial transparency, support strategic decision-making, and ensure the organization's financial health.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Financial" && user.team === "Accounting");
                setTeamMembers(SocialMediaTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Accounting - {visibleMembers.length}/{teamMembers.length}</h1>
