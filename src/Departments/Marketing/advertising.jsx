...
export const Advertising = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Advertising team is responsible for creating and executing advertising campaigns that resonate with our audience. Our mission is to craft compelling messages and visuals that amplify our brand's presence in the market.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const AdvertisingTeam = data.filter(user => user.department === "Marketing" && user.team === "Advertising");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Advertising - {visibleMembers.length}/{teamMembers.length}</h1>
