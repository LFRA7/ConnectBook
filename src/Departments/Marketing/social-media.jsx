...
export const SocialMedia = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Social Media team is responsible for managing the brand's presence on social media platforms. Their main goal is to increase brand visibility, engage with the audience, and drive conversions through strategic content and digital interactions.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SocialMediaTeam = data.filter(user => user.department === "Marketing" && user.team === "Social Media");
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Social Media - {visibleMembers.length}/{teamMembers.length}</h1>
