...
export const Events = () => {
    ...
    useEffect(() => {
        const teamDescription = "The Events Team is responsible for planning, organizing, and executing events that promote the brand, engage the target audience, and strengthen business relationships. Their goal is to create impactful experiences that enhance brand awareness, generate leads, and support overall marketing objectives.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const EventsTeam = data.filter(user => user.department === "Marketing" && user.team === "Events");
                setTeamMembers(EventsTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>Events - {visibleMembers.length}/{teamMembers.length}</h1>
