...
export const SEO = () => {
    ...
    useEffect(() => {
        const teamDescription = "The SEO (Search Engine Optimization) Team is responsible for improving the company's online visibility by optimizing website content, structure, and technical aspects to rank higher in search engine results. Their goal is to drive organic traffic, enhance user experience, and increase conversions through data-driven SEO strategies.";
    ...
    useEffect(() => {
        fetch("http://localhost:3000/users")
            ...
            .then(data => {
                const SEOTeam = data.filter(user => user.department === "Marketing" && user.team === "SEO");
                setTeamMembers(SEOTeam);
            })
    ...
    return (
        <div className="app-container">
            ...
            <div className="title-teams">
                ...
                <h1>SEO - {visibleMembers.length}/{teamMembers.length}</h1>
